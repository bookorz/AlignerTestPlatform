classdef MeasureUtility < handle
    ...
    methods (Static)
        ...
        function Reset_All()
            MeasureUtility.Var_average_t('reset');
                MeasureUtility.Var_max_t('reset');
                MeasureUtility.Var_min_t('reset'); 
                MeasureUtility.Var_average_x0('reset'); 
                MeasureUtility.Var_average_y0('reset'); 
                MeasureUtility.Var_average_point_1('reset'); 
                MeasureUtility.Var_average_point_2('reset'); 
                %MeasureUtility.Var_r('reset'); 
                %MeasureUtility.Var_pixel('reset'); 
                MeasureUtility.Var_offset_mm('reset'); 
                MeasureUtility.Var_offset_deg('reset'); 
                MeasureUtility.Var_notch_deg('reset'); 
                MeasureUtility.Var_center_deg('reset'); 
                MeasureUtility.Var_center_mm('reset'); 
                MeasureUtility.Var_n('reset'); 
                MeasureUtility.Var_average_theta('reset'); 
                MeasureUtility.Var_average_theta1('reset');  
                MeasureUtility.Var_R_interval_fqc1(double.empty(0));
                MeasureUtility.Var_R_interval_fqc2(double.empty(0));
                MeasureUtility.Var_R_interval_fqc3(double.empty(0));
                MeasureUtility.Var_R_interval_fqc4(double.empty(0));
                MeasureUtility.Var_R_interval_fqc5(double.empty(0));
                MeasureUtility.Var_R_interval_fqc6(double.empty(0));
                MeasureUtility.Var_S_interval_fqc1(double.empty(0));
                MeasureUtility.Var_S_interval_fqc2(double.empty(0));
                MeasureUtility.Var_S_interval_fqc3(double.empty(0));
                MeasureUtility.Var_S_interval_fqc4(double.empty(0));
                MeasureUtility.Var_S_interval_fqc5(double.empty(0));
                MeasureUtility.Var_S_interval_fqc6(double.empty(0));
                MeasureUtility.Var_FQC(0);
                MeasureUtility.Var_offset_mm_interval('reset');
                MeasureUtility.Var_offset_deg_interval('reset');
                MeasureUtility.Var_notch_deg_interval('reset');
                MeasureUtility.Var_center_mm_interval('reset');
        end
        ...
        function func_r = Var_r()
            func_r = ((MeasureUtility.Var_average_point_1 - MeasureUtility.Var_average_x0)^2 + (MeasureUtility.Var_average_point_2-MeasureUtility.Var_average_y0)^2)^0.5;
        end
        ...
        function func_offset_mm = Var_offset_mm(newval)
            ...
            elseif strcmp(MeasureUtility.WaferType ,'FLAT')
                func_offset_mm = MeasureUtility.Var_center_mm;
            end
        end
        ...
        function func_offset_deg = Var_offset_deg(newval)
            ...
            elseif strcmp(MeasureUtility.WaferType,'FLAT')
                ...
                func_offset_deg = MeasureUtility.Var_notch_deg;
            end
        end
